...
class BlockWorldAgent:
    ...
    def solve(self):
        ...
        initial_arrangement = self.get_arrangement("Enter the initial arrangement: ")

        
        goal_arrangement = self.get_arrangement("Enter the goal arrangement: ")

        
        solution = self.solve_block_world(initial_arrangement, goal_arrangement)
        print("Solution:", solution)

    def get_arrangement(self, message):
        arrangement = []
        print(message)
        while True:
            line = input().strip()
    ...
    def solve_block_world(self, initial_arrangement, goal_arrangement):
